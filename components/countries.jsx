...
import { ArrowLeft, Sparkles, Trophy, Star, Award, TrendingUp, Users } from "lucide-react"

// Animated Counter Component (No changes, already efficient)
  ...
  const countries = [
    {
      ...
      key: "saudi_arabia",
      projects: getProjectsByCountry("saudi_arabia").length,
      color: "emerald",
      icon: Trophy,
    },
    {
      ...
      projects: getProjectsByCountry("united_arab_emirates").length,
      color: "sky",
      icon: Star,
    },
    {
      ...
      key: "qatar",
      projects: getProjectsByCountry("qatar").length,
      color: "rose",
      icon: Award,
    },
    {
      ...
      key: "egypt",
      projects: getProjectsByCountry("egypt").length,
      color: "amber",
      icon: TrendingUp,
    },
  ];
